...
## Forms & inbound
- Website forms post to /api/public/forms/submit. Each automation of type deal_creation has a form_id config (e.g. "summer", "gapyear", "university"); the submission's form_id is matched to find which automation fires.
