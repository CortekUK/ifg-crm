        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              link to set a new password — works whether you&apos;ve logged in before
          ...
          {recoveryDone ? (
            ...
            <form onSubmit={handleRecoverySubmit} className="space-y-3">
              <div className="space-y-1.5">
                <Label htmlFor="recovery-email" className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400">
                  Email Address
                </Label>
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-gray-400 dark:text-gray-500" />
