// Canonical merge-tag replacement core for the Next.js side.
// Used by lib/utils/mergeTags.ts, which wraps this module and adds
// UI-only helpers (MERGE_TAGS catalog, preview, validate, extract).
//
// MIRROR: supabase/functions/_shared/merge-tags.ts
