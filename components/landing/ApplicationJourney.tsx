      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:block">
          <div className="relative">
            {/* Connecting line */}
            <div className="absolute top-8 left-[calc(12.5%+32px)] right-[calc(12.5%+32px)] h-px bg-gradient-to-r from-red-600/30 via-gray-300 to-red-600/30 dark:from-red-600/20 dark:via-white/10 dark:to-red-600/20" />
              ...
              {steps.map((step, i) => (
                <FadeIn key={step.number} delay={i * 120} threshold={0.1}>
                  <div className="text-center">
                    ...
                    <h3 className="font-oswald text-[15px] font-bold uppercase tracking-tight text-gray-900 dark:text-foreground mb-2">
                      {step.title}
                    </h3>
        ...
        <div className="md:hidden">
          <div className="relative pl-10">
            ...
            <div className="absolute left-[15px] top-0 bottom-0 w-px bg-gradient-to-b from-red-600/30 via-gray-300 to-red-600/30 dark:from-red-600/20 dark:via-white/10 dark:to-red-600/20" />
              ...
              {steps.map((step, i) => (
                <FadeIn key={step.number} delay={i * 100} from="left">
                  <div className="relative flex items-start gap-5">
                    ...
                    <div>
                      <h3 className="font-oswald text-[15px] font-bold uppercase tracking-tight text-gray-900 dark:text-foreground mb-1">
                        {step.title}
                      </h3>
