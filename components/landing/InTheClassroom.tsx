    ...
    <section className="py-20 md:py-28 bg-white dark:bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn className="max-w-3xl mb-10 md:mb-14">
          ...
          <p className="mt-5 text-base text-gray-600 dark:text-muted-foreground leading-relaxed">
        ...
        <FadeIn threshold={0.1}>
          <div className="relative rounded-xl overflow-hidden">
            ...
            <div className="flex items-center gap-5 bg-gray-50 dark:bg-white/[0.04] border-t border-gray-200 dark:border-white/10 px-6 py-4">
              <Image
                src="/landing/logos/uclan-white.png"
                alt="University of Central Lancashire"
                width={120}
                height={44}
                className="h-8 w-auto shrink-0 dark:opacity-70 invert dark:invert-0"
              />
              <div className="w-px h-6 bg-gray-300 dark:bg-white/10 shrink-0" />
              <div className="flex flex-col">
                <span className="text-[11px] font-bold uppercase tracking-widest text-gray-400 dark:text-white/35">
                  Official Academic Partner
                </span>
                <span className="text-[13px] font-medium text-gray-600 dark:text-white/50 leading-snug mt-0.5">
        ...
        <FadeIn delay={100} className="mt-14 md:mt-18">
          <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-gray-400 dark:text-white/30 block mb-6">
            Education Pathway
          </span>
          ...
          <div className="hidden md:grid md:grid-cols-4 gap-0 relative">
            ...
            <div className="absolute top-[22px] left-[calc(12.5%+24px)] right-[calc(12.5%+24px)] h-px bg-gradient-to-r from-red-600/30 via-gray-200 to-red-600/30 dark:from-red-600/20 dark:via-white/10 dark:to-red-600/20" />

            {pathway.map((step, i) => (
              <div key={step.step} className="relative text-center px-5">
                <div className="relative z-10 w-11 h-11 rounded-full border-2 border-red-600 bg-white dark:bg-[#0A0A0A] flex items-center justify-center mx-auto mb-5">
                  <span className="font-oswald text-sm font-bold text-red-600">{step.step}</span>
                </div>
                <h3 className="font-oswald text-[15px] font-bold uppercase tracking-wide text-gray-900 dark:text-foreground mb-2.5">
                  {step.title}
                </h3>
                <p className="text-[13px] text-gray-500 dark:text-white/45 leading-relaxed">
                  {step.description}
                </p>
              </div>
            ))}
          ...
          <div className="md:hidden space-y-0 relative">
            ...
            <div className="absolute top-6 bottom-6 left-[21px] w-px bg-gradient-to-b from-red-600/30 via-gray-200 to-red-600/30 dark:from-red-600/20 dark:via-white/10 dark:to-red-600/20" />

            {pathway.map((step) => (
              <div key={step.step} className="relative flex gap-5 py-4">
                <div className="relative z-10 w-11 h-11 rounded-full border-2 border-red-600 bg-white dark:bg-[#0A0A0A] flex items-center justify-center shrink-0">
                  <span className="font-oswald text-sm font-bold text-red-600">{step.step}</span>
                </div>
                <div className="pt-2">
                  <h3 className="font-oswald text-[15px] font-bold uppercase tracking-wide text-gray-900 dark:text-foreground mb-1">
                    {step.title}
                  </h3>
                  <p className="text-[13px] text-gray-500 dark:text-white/45 leading-relaxed">
                    {step.description}
        ...
        <FadeIn delay={200} className="mt-12 md:mt-16">
          <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] p-6 md:p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-[2px] bg-red-600" />
              <span className="font-oswald text-base font-semibold uppercase tracking-wider text-gray-900 dark:text-foreground">
                For Parents
              </span>
            </div>
            <p className="text-sm text-gray-500 dark:text-white/40 leading-relaxed mb-8 max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-6">
              {parentPoints.map((point) => (
                <div key={point.label} className="border-l-2 border-red-600/25 dark:border-red-600/20 pl-4">
                  <h4 className="text-sm font-semibold text-gray-900 dark:text-foreground mb-1.5">
                    {point.label}
                  </h4>
                  <p className="text-[13px] text-gray-500 dark:text-white/45 leading-relaxed">
                    {point.detail}
