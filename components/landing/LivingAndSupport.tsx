      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          {facilities.map((facility, i) => (
            ...
            >
              <div className="group relative rounded-xl overflow-hidden h-64 lg:h-80 shadow-lg">
                <Image
                  src={facility.image}
                  alt={facility.name}
                  fill
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <FadeIn from="left">
            ...
            <h3 className="font-oswald text-2xl md:text-3xl font-bold uppercase tracking-tight text-gray-900 leading-[1.1] mt-2 mb-4">
          ...
          <FadeIn from="right" delay={100}>
            ...
            <div className="space-y-6">
              {accommodation.map((acc) => (
                ...
                >
                  <span className="text-[11px] font-semibold uppercase tracking-widest text-red-600 mb-3">
                    {acc.type}
                  </span>
