    ...
    <footer className="bg-[#050505] text-gray-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-lg font-extrabold text-white tracking-tight font-oswald uppercase">
                  Football Group
                </span>
              </div>
            </div>
            <p className="text-sm text-gray-500 leading-relaxed">
              Developing international footballers through education, elite coaching, and professional pathways.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <a
                href="https://www.instagram.com/theinternationalfootballgroup/"
                target="_blank"
              ...
              <a
                href="https://twitter.com/ifaboroad"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-white transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://www.facebook.com/theinternationalfootballgroup"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-white transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://www.youtube.com/@IFGfootball"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-white transition-colors"
                aria-label="YouTube"
          ...
          {/* Programmes */}
          <div>
            <h4 className="font-oswald text-xs font-semibold uppercase tracking-[0.15em] text-white/70 mb-5">
              Programmes
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/landing" className="text-sm text-gray-500 hover:text-white transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/landing/programmes" className="text-sm text-gray-500 hover:text-white transition-colors">
                  All Programmes
                </Link>
              </li>
              <li>
                <Link href="/landing#testimonials" className="text-sm text-gray-500 hover:text-white transition-colors">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="/landing#faq" className="text-sm text-gray-500 hover:text-white transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/landing#enquire" className="text-sm text-gray-500 hover:text-white transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-500 mb-8">
              <p>info@theinternationalfootballgroup.com</p>
              <p>Macclesfield, Cheshire, UK</p>
            </div>
            <h4 className="font-oswald text-xs font-semibold uppercase tracking-[0.15em] text-white/70 mb-4">
              Partners
            </h4>
        ...
        <div className="border-t border-white/5 mt-14 pt-8">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 mb-8">
            ...
            <Image
              ...
              width={36}
              height={36}
              className="h-9 w-auto opacity-40 hover:opacity-70 transition-opacity"
            />
            <Image
              src="/landing/logos/ifg-crest.png"
              alt="IFG"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-gray-600">
              &copy; {new Date().getFullYear()} The International Football Group. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-xs text-gray-600">
              <span>Macclesfield, UK</span>
              <span>&bull;</span>
              <span>Preston, UK</span>
            </div>
          </div>
        </div>
      </div>
