...
export function V2MatchdayProof() {
  ...
  return (
    <section className="overflow-hidden">
      {/* Stats strip + video zone */}
      <div className="relative py-20 md:py-28 bg-[#0A0A0A]">
        {/* Background image */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn delay={100} className="mb-12">
            <div className="flex flex-wrap items-baseline gap-8 md:gap-12">
              {stats.map((stat, i) => (
                <div key={stat.label} className="flex items-baseline gap-2">
                  {i > 0 && (
                    <div className="w-px h-6 bg-white/15 -ml-4 md:-ml-6 mr-1 self-center hidden sm:block" />
                  )}
                  <span className="font-oswald text-4xl md:text-5xl font-bold text-white tracking-tight leading-none">
                    {stat.value}
                  </span>
                  <span className="text-[11px] font-medium uppercase tracking-wider text-white/40 max-w-[80px] leading-tight">
                    {stat.label}
                  </span>
                </div>
              ))}
      ...
      <div className="py-14 md:py-20 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
            {/* Featured: Carlos Dos Santos — 2 cols */}
