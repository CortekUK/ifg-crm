...
import { Code2, Search, User, Briefcase, UserCircle } from 'lucide-react'
      ...
      <PopoverContent className="w-80 p-0" align="start">
        ...
        <div className="max-h-[300px] overflow-y-auto p-2">
          {Object.entries(groupedVariables).map(([category, variables]) => {
            ...
            const categoryLabel = templateVariableCategories[category as keyof typeof templateVariableCategories] || category
            
            return (
              <div key={category} className="mb-3 last:mb-0">
                <div className="flex items-center gap-1.5 px-2 py-1 text-xs font-semibold text-muted-foreground uppercase">
