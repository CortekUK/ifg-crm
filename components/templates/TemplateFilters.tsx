...
// The "Unused" toggle was removed — it surfaced orphan templates that
// no automation/campaign referenced, but the user found it noisy in
// the toolbar and uses delete + the existing list to manage cleanup
// instead.
