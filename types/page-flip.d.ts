...
//
// MIRROR: web/types/page-flip.d.ts. The CRM's staff preview and the public
// viewer mount the same library with the same settings, so a change to one of
// these declarations belongs in both.
